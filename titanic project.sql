...
select count(*) as missing_age from titanic where age is null;
...
select concat((count(case when survived = 'survived' then 1 end)*100)/count(*)) as survival_percentage from titanic;
